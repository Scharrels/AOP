...
public class StoreTest {
	...
	public static void main(String[] args){
		...
		// customer 1 wants to buy a copy of lord of the rings
		System.out.println("Test: checkout with sufficient stock (2,1) and sufficient funds");
		customer1.addToBasket(product1);
		tryCheckout(customer1);
		customer1.clearBasket();
		
		System.out.println("Test: checkout with insufficient stock (2,0) and sufficient funds");
		customer2.addToBasket(product1);
		customer2.addToBasket(product2);
		tryCheckout(customer2);
		customer2.clearBasket();
		
		System.out.println("Test: checkout with sufficient stock (2,0) and insufficient funds");
